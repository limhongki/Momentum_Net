function [etime,RMSEtest,Irecon_test_ls] = func_test_momentum_scnn(num,ld,rho,data_name)
...
for kp = 1:num
    ...
    py.mypcodes.test_scnn.test(int32(kp-1),...
        pyargs('data_name', data_name, 'which_gpu',which_gpu));
